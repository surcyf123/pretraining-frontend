...
def handler(event, context):
    ...
    sorted_output = sorted(smoothed_data, key = lambda ele  : ele["timestamp"]) # Ref: https://stackoverflow.com/questions/72899/how-to-sort-a-list-of-dictionaries-by-a-value-of-the-dictionary-in-python
